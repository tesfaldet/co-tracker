...
srun --label python ${EXP_DIR}/${DATE}_${EXP_NAME}/cotracker3/train_on_pod.py --batch_size 1 \
...
--traj_per_sample 128 --sliding_window_len 16 --train_datasets pointodyssey \
